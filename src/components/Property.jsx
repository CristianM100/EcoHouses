...
import { usePropertyContext } from '../context/PropertyContext'; // adjust path if needed
//import { addToFavourites } from '../http';
import React from 'react';



function Property({ id, title, images, location, favorite, description, facilities, sustainability, price, type }) {
      ...
      <div className="border border-gray-400 rounded-lg p-3">
        ...
        <div className="pt-3 flex justify-between items-start">
          ...
          <div className="flex flex-col items-end space-y-2">
            <button
              onClick={(e) => {
                e.stopPropagation(); // Prevent propagation to Link
